...
bottom_table_code = """
        ...
        {pdfDoc && (
          <div className="h-[250px] lg:h-[300px] border-t border-gray-300 bg-white flex flex-col shrink-0 z-20 w-full" style={{ zIndex: 30 }}>
...
print("Final replacement done cleanly")
