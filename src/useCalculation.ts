...
import { computeTotalCo2, materialsMissingCo2, Co2Breakdown } from './climate/co2';
...
export function computeCalculation(
  ...
  const co2 = computeTotalCo2(byggdelar, materials);
  const co2Missing = materialsMissingCo2(byggdelar, materials);
