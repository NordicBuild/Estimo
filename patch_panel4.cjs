...
code = code.replace(/      setActiveModelLocal\(modelId, newElements as any, parsedModel\.meshes\);/, `      setActiveModelLocal(modelId, newElements as any, parsedModel.meshes);

\${bgTask}`);

fs.writeFileSync(file, code);
console.log('Patched BIMLeftPanel.tsx bg task');
